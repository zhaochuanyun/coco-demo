...
// {Args: 5}
package thinking.in.java.concurrency.restaurant2;
...
public class RestaurantWithQueues {
   ...
   * Output: (Sample) WaitPerson 0 received SPRING_ROLLS delivering to Customer 1 Customer 1 eating
   * SPRING_ROLLS WaitPerson 3 received SPRING_ROLLS delivering to Customer 0 Customer 0 eating
   * SPRING_ROLLS WaitPerson 0 received BURRITO delivering to Customer 1 Customer 1 eating BURRITO
   * WaitPerson 3 received SPRING_ROLLS delivering to Customer 2 Customer 2 eating SPRING_ROLLS
   * WaitPerson 1 received SOUP delivering to Customer 3 Customer 3 eating SOUP WaitPerson 3
   * received VINDALOO delivering to Customer 0 Customer 0 eating VINDALOO WaitPerson 0 received
