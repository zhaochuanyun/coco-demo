...
public class Rethrowing {
   ...
   * h(),e.printStackTrace() java.lang.Exception: thrown from f() at Rethrowing.f(Rethrowing.java:7)
   * at Rethrowing.h(Rethrowing.java:20) at Rethrowing.main(Rethrowing.java:35) main:
   * printStackTrace() java.lang.Exception: thrown from f() at Rethrowing.h(Rethrowing.java:24) at
