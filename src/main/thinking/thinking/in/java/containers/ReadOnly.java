...
public class ReadOnly {
    ...
    public static void main(String[] args) {
        ...
        Map<String, String> m = Collections.unmodifiableMap(new HashMap<String, String>(Countries
                .capitals(6)));
        print(m); // Reading is OK
        // ! m.put("Ralph", "Howdy!");

        // For a SortedMap:
        Map<String, String> sm = Collections.unmodifiableSortedMap(new TreeMap<String, String>(
                Countries.capitals(6)));
    }
} /*
   * Output: [ALGERIA, ANGOLA, BENIN, BOTSWANA, BULGARIA, BURKINA FASO] ALGERIA [BULGARIA, BURKINA
   * FASO, BOTSWANA, BENIN, ANGOLA, ALGERIA] {BULGARIA=Sofia, BURKINA FASO=Ouagadougou,
   * BOTSWANA=Gaberone, BENIN=Porto-Novo, ANGOLA=Luanda, ALGERIA=Algiers}
   */// :~
