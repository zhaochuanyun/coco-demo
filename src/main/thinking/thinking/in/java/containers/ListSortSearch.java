...
public class ListSortSearch {
   ...
   * Output: [one, Two, three, Four, five, six, one, one, Two, three, Four, five, six, one]
   * Shuffled: [Four, five, one, one, Two, six, six, three, three, five, Four, Two, one, one]
   * Trimmed: [Four, five, one, one, Two, six, six, three, three, five] Sorted: [Four, Two, five,
   * five, one, one, six, six, three, three] Location of six is 7, list.get(7) = six
   * Case-insensitive sorted: [five, five, Four, one, one, six, six, three, three, Two] Location of
   * three is 7, list.get(7) = three
   */// :~
