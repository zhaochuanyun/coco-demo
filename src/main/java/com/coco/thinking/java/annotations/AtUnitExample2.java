...
public class AtUnitExample2 {
   ...
   * java.io.FileNotFoundException: nofile.txt (The system cannot find the file specified) (failed)
   * . assertAndReturn This is methodTwo
   * 
   * (4 tests)
   * 
   * >>> 2 FAILURES <<< annotations.AtUnitExample2: assertFailureExample annotations.AtUnitExample2:
   * exceptionExample
   */// :~
