...
public class RandomTest {
   ...
   * Output: STANDING FLYING RUNNING STANDING RUNNING STANDING LYING DODGING SITTING RUNNING HOPPING
   * HOPPING HOPPING RUNNING STANDING LYING FALLING RUNNING FLYING LYING
   */// :~
