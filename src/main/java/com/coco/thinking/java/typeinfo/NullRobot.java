...
public class NullRobot {
   ...
   * Output: Robot name: SnowBee Robot model: SnowBot Series 11 SnowBee can shovel snow SnowBee
   * shoveling snow SnowBee can chip ice SnowBee chipping ice SnowBee can clear the roof SnowBee
   * clearing roof [Null Robot] Robot name: SnowRemovalRobot NullRobot Robot model: SnowRemovalRobot
   * NullRobot
   */// :~
