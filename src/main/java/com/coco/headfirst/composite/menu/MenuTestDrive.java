package com.coco.headfirst.composite.menu;
...
public class MenuTestDrive {
    public static void main(String args[]) {
        ...
        dessertMenu.add(new MenuItem("Sorbet", "A scoop of raspberry and a scoop of lime", true,
                1.89));
        ...
        coffeeMenu.add(new MenuItem("Coffee Cake", "Crumbly cake topped with cinnamon and walnuts",
                true, 1.59));
        coffeeMenu.add(new MenuItem("Bagel",
                "Flavors include sesame, poppyseed, cinnamon raisin, pumpkin", false, 0.69));
        coffeeMenu.add(new MenuItem("Biscotti", "Three almond or hazelnut biscotti cookies", true,
                0.89));
