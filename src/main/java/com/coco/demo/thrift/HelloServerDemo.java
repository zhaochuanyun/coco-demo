 ...
 * 
 * @see http://my.oschina.net/jack230230/blog/66041
 * @see http://www.sxt.cn/u/1/blog/3300
 */
public class HelloServerDemo {
    ...
    public void startServer() {
        try {
            ...
            // TProcessor tprocessor = new HelloWorldService.Processor<HelloWorldService.Iface>(new
            // HelloWorldImpl());
