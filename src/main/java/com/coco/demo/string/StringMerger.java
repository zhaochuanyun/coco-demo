...
public class StringMerger {
     ...
     * @param separator
     *            The separator should be place between strings in the new string. There will be no
     *            separator when give a null or "" here.
     * @param isSepAtTail
     *            Set if the separator will be append at the tail.
    ...
    public static void main(String[] args) {
        ...
        System.out.println(StringMerger.bufferMerge(new String[] { "a", "kk", "ef" }, " ^_^ ",
                false));
